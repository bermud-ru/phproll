...
class Db
{
    ...
    public function insert(string $table, array $fields, $keys = true): bool
    {
        ...
        //$params = array_intersect_key(($this->index ? $this->parent->params[$this->index] : $this->parent->params), ($keys ? $fields : array_flip(array_values($fields))));
        //array_walk($params, function(&$v){$v=strval($v);});
